...
@Mod("bbifounders")
public class TheFounders
{
    // Directly reference a log4j logger.
    private static final Logger LOGGER = LogManager.getLogger();
    public static final String MOD_ID = "bbifounders";
    ...
    public static final ItemGroup TAB = new ItemGroup("bbiFounders") {
        @Override
        public ItemStack createIcon(){
            return new ItemStack(RegistryHandler.STEEL_OF_THE_FOUNDERS.get());
        }
    };
